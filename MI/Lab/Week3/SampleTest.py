...
def test_case():
    ...
    try:
        geod = get_entropy_of_dataset(df)
        if geod >= 0.938 and geod <= 0.942:
    ...
    try:
        gaia = get_avg_info_of_attribute(df, 'outlook')
        if gaia >= 0.691 and gaia <= 0.695:
        ...
        print("Test Case 2 for the function get_avg_info_of_attribute FAILED - EXCEPTION")
    ...
    try:
        ...
        print("Test Case 4 for the function get_selected_attribute FAILED-EXCEPTION")
